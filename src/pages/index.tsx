  ...
  const services = [
    {
      ...
      description: "Статический и динамический анализ программного обеспечения с использованием специализированных инструментов для обнаружения дефектов и уязвимостей в коде на ранних стадиях разработки.",
      path: "/contacts",
    },
    {
      icon: "🛡️",
